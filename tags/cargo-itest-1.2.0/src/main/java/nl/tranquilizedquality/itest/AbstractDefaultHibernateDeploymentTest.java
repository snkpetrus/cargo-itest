 ...
 * the common-hibernate-db-context.xml. If you do not specify the list of SQL
 * scripts it will not execute any scripts so you are free to use SQL scripts or
 * any other method you like to use for creating test data.
 * 
...
@ContextConfiguration(locations = {
        "classpath:common-hibernate-db-context.xml",
